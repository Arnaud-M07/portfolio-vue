    ...
    <div class="container">
      <div class="row" data-aos="fade-up">
        ...
        <div class="col-12 col-lg-6 text-end">
          <h3>
            Discover some of my latest projects, where every line of code creates unique experiences.
          </h3>
        </div>
      </div>
      <hr /><hr />
...
<script setup>
// Liste des projets (équivalent de ton tableau PHP)
